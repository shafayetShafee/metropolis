...
## Media Backgrounds {background-image="metropolis_template_images/milky-way.jpeg"}
...
![](metropolis_template_images/kitten-400-350.jpeg){.absolute top="170" left="30" width="400" height="400"}

![](metropolis_template_images/kitten-450-250.jpeg){.absolute .fragment top="150" right="80" width="450"}

![](metropolis_template_images/kitten-300-200.jpeg){.absolute .fragment bottom="110" right="130" width="300"}
...
::: {layout-ncol="2"}
![](metropolis_template_images/moon.png)

![](metropolis_template_images/sky.png)
:::
...
::: {layout="[1, 20]"}
![](metropolis_template_images/presentation-menu.png){width="41"}
...
::: {layout="[1, 20]"}
![](metropolis_template_images/presentation-chalkboard.png){width="41"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](metropolis_template_images/presentation-notes-canvas.png){width="41"}
...
![](metropolis_template_images/overview-mode.png){.border}
...
![](metropolis_template_images/speaker-view.png){fig-align="center" style="border: 3px solid #dee2e6;" width="780"}
...
::: columns
::: {.column width="50%"}
![](metropolis_template_images/jupyter-edit.png){.border .border-thick}
:::

::: {.column width="50%"}
![](metropolis_template_images/jupyter-preview.png){.border .border-thick}
:::
:::
...
![](metropolis_template_images/rstudio.png){.border width="900"}
